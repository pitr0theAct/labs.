...
int main()
{
    ...
    figures.push_back(new Triangle(0, 0, Color::PINK, 3, 4, 5));
    figures.push_back(new Rectangle(0, 0, Color::WHITE, 6, 10));
    figures.push_back(new Circle(0, 0, Color::GREEN, 10));
